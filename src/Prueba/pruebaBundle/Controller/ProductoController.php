...
class ProductoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PruebapruebaBundle:Producto')->findAll();
     ...
     * @Method("POST")
     * @Template("PruebapruebaBundle:Producto:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PruebapruebaBundle:Producto')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PruebapruebaBundle:Producto:edit.html.twig")
     */
